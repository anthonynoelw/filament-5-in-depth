...
class FeatureForm
{
                ...
                Tabs::make('Tabs')
                    ...
                    ->tabs([
                        Tabs\Tab::make('Feature Details')
                            ->columns(3)
                            ->schema(
                                self::getFeatureDetailSchema(),
                            ),
                        Tabs\Tab::make('Additional Information')
                            ->columns(2)
                            ->schema(
                                self::getAdditionalInformationSchema(),
                            ),
                        Tabs\Tab::make('Milestone')
                            ->columns(1)
                            ->schema(
                                self::getMilestoneSchema(),
                            ),
                    ]),
    ...
    private static function getFeatureDetailSchema(): array
    {
        return [
    ...
    private static function getAdditionalInformationSchema(): array
    {
        return [
            TextInput::make('effort_in_days')
                ->required()
    ...
    private static function getMilestoneSchema(): array
    {
        return [
            Repeater::make('milestones')
                ...
                ->table([
                    ...
                    TableColumn::make('due_date')->markAsRequired(),
